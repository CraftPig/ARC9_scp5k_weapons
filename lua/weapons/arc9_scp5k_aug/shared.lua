...
SWEP.CustomSelectIcon = Material("vgui/hud/arc9_scp5k_aug")
-------------------------------------------------------------------------------------------------------
-- Define Base ----------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------
SWEP.Base = "arc9_base"
...
SWEP.Description = [[The AUG A3 is a bullpup assault rifle known for its futuristic design, reliability, and versatility. It features a compact layout with a modular design, allowing for easy customization with various accessories and optics. The bullpup configuration provides a longer barrel length in a shorter overall package, enhancing maneuverability without sacrificing barrel length or accuracy.]]

-------------------------------------------------------------------------------------------------------
-- Viewmodel & Worldmodel -----------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------
SWEP.ViewModel = "models/weapons/arc9_scp5k/aug/v_aug.mdl"
SWEP.UseHands = true
...
SWEP.RangeMin = 1980 -- How far bullets retain their maximum damage for.
SWEP.RangeMax = 6693 -- In Hammer units, how far bullets can travel before dealing DamageMin.
...
SWEP.MuzzleParticle = { "port_smoke_heavy", "muzzleflash_OTS", "muzzleflash_4" }
...
SWEP.ActivePos = Vector(-0.5, 1.75, 0.25)
...
SWEP.CustomizeRotateAnchor = Vector(7, -2, -5)
...
SWEP.ShootSound               = { "WeaponARC9_AUG_Fire" }
SWEP.LayerSound               = { "WeaponARC9_MK18_Outdoor" }
SWEP.ShootSoundIndoor         = { "WeaponARC9_AUG_Fire" }
SWEP.LayerSoundIndoor         = { "WeaponARC9_MK18_Indoor" }
SWEP.ShootSoundSilenced       = { "WeaponARC9_AUG_FireSilenced" } 
SWEP.ShootSoundSilencedIndoor = { "WeaponARC9_AUG_FireSilenced" }
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        FireASAP = true,
		EventTable = {
            {s = "WeaponARC9_AUG_MagOut", t = 0 / 30},
			{s = "WeaponARC9_AUG_MagPouchDown", t = 20 / 30},
			{s = "WeaponARC9_AUG_MagIn", t = 47 / 30},
            {s = "WeaponARC9_AUG_ReloadMagSlap", t = 81 / 30},
	...
	["reload_empty"] = {
		...
		EventTable = {
			...
			{s = "WeaponARC9_AUG_EmptyBoltBack", t = 0 / 30},
			{s = "WeaponARC9_AUG_EmptyMagOut", t = 25 / 30},
			{s = "WeaponARC9_AUG_EmptyMagIn", t = 56 / 30},
			{s = "WeaponARC9_AUG_EmptyBolt", t = 85 / 30},
        },
		IKTimeLine = {
            {
                t = 0,
    ...
    ["inspect_look"] = {
        ...
        FireASAP = true,
		EventTable = {
            {s = "WeaponARC9_AUG_InspectRotate", t = 0 / 30},
			{s = "WeaponARC9_AUG_BoltBack", t = 71 / 30},
            {s = "Generic_ClothEquip", t = 108 / 30},
        },
		IKTimeLine = {
            {
                t = 0,
	...
	["inspect"] = {
        ...
        FireASAP = true,
		EventTable = {
            {s = "WeaponARC9_AUG_MagCheckOut", t = 0 / 30},
			{s = "WeaponARC9_AUG_MagCheckIn", t = 65 / 30},
        },
		IKTimeLine = {
            {
                t = 0,

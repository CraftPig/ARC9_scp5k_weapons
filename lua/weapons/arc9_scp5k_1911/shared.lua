...
SWEP.CustomSelectIcon = Material("vgui/hud/arc9_scp5k_1911")
-------------------------------------------------------------------------------------------------------
-- Define Base ----------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------
SWEP.Base = "arc9_base"
...
SWEP.Description = [[The Colt 1911 is a classic .45 ACP semi-automatic pistol with a rich history. Adopted by the U.S. military in 1911, it's known for its all-steel construction, single-action operation, and distinctive safeties. Reliable and accurate, it remains popular and highly customizable among gun enthusiasts.]]

-------------------------------------------------------------------------------------------------------
-- Viewmodel & Worldmodel -----------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------
SWEP.ViewModel = "models/weapons/arc9_scp5k/1911/v_1911.mdl"
SWEP.UseHands = true
...
SWEP.RangeMax = 4710 -- In Hammer units, how far bullets can travel before dealing DamageMin.
SWEP.Distance = 33000 -- In Hammer units, how far bullets can travel, period.

SWEP.AlwaysPhysBullet = false
SWEP.NeverPhysBullet = false

SWEP.PhysBulletMuzzleVelocity = 10000 -- Physical bullet muzzle velocity in Hammer Units/second. 1 HU != 1 inch.
...
SWEP.MuzzleParticle = { "shellsmoke", "muzzleflash_OTS", "muzzleflash_pistol_red" }
...
SWEP.ShootSound               = { "WeaponARC9_1911_Fire" }
SWEP.LayerSound               = { "WeaponARC9_57_TailOutdoor" }
SWEP.ShootSoundIndoor         = { "WeaponARC9_1911_Fire" }
SWEP.LayerSoundIndoor         = { "WeaponARC9_GLOCK_TailIndoor" }
SWEP.ShootSoundSilenced       = { "WeaponARC9_1911_FireSilenced" } 
SWEP.ShootSoundSilencedIndoor = { "WeaponARC9_1911_FireSilenced" }
...
SWEP.DryFireSound = "WeaponARC9_1911_Dryfire"
...
SWEP.Animations = {
    ...
    ["draw"] = {
        ...
        FireASAP = true,
		EventTable = {
            {s = "WeaponARC9_1911_Equip", t = 0 / 30},
	...
	["holster"] = {
        ...
        FireASAP = true,
		EventTable = {
            {s = "WeaponARC9_1911_Unequip", t = 0 / 30},
    ...
    ["reload"] = {
        ...
        FireASAP = true,
		EventTable = {
            {s = "WeaponARC9_1911_Start", t = 0 / 30},
			{s = "WeaponARC9_1911_MagPouchDown", t = 0 / 30},
			{s = "WeaponARC9_1911_MagOut", t = 10 / 30},
			{s = "WeaponARC9_1911_MagIn", t = 30 / 30},
	...
	["reload_empty"] = {
        ...
        FireASAP = true,
		EventTable = {
            {s = "WeaponARC9_1911_EmptyMagOut", t = 0 / 30},
			{s = "WeaponARC9_1911_EmptyMagPouchDown", t = 10 / 30},
	...
	["inspect_look"] = {
        ...
        FireASAP = true,
		EventTable = {
            {s = "WeaponARC9_1911_InspectRotate", t = 0 / 30},
			{s = "WeaponARC9_1911_BoltBack", t = 65 / 30},

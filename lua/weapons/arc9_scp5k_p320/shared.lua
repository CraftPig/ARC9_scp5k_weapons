...
SWEP.CustomSelectIcon = Material("vgui/hud/arc9_scp5k_p320")
-------------------------------------------------------------------------------------------------------
-- Define Base ----------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------
SWEP.Base = "arc9_base"
...
SWEP.Description = [[The Sig Sauer P320 is a modular and striker-fired pistol known for its adaptability. Available in various sizes and calibers, its unique design allows users to change grip modules and slides for customization. The P320 is recognized for its reliability and has been adopted by military and law enforcement agencies.]]

-------------------------------------------------------------------------------------------------------
-- Viewmodel & Worldmodel -----------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------
SWEP.ViewModel = "models/weapons/arc9_scp5k/p320/v_p320.mdl"
SWEP.UseHands = true

SWEP.WorldModel = "models/weapons/w_pist_usp.mdl"
SWEP.MirrorVMWM = true 
 SWEP.WorldModelOffset = {
     Pos = Vector(-12, 4.5, -7), -- non tpik (while on ground, on npc etc)
     Ang = Angle(0, 0, 180),
     TPIKPos = Vector(-12, 1.2, -4), -- arc9_tpik 1, you can make cool poses with it
...
SWEP.RangeMax = 2600 -- In Hammer units, how far bullets can travel before dealing DamageMin.
...
SWEP.RecoilRandomSideAddSighted = -2.5
...
SWEP.SprintPos = Vector(-3.75, -8, 1.5)
...
SWEP.CustomizePos = Vector(16.5, 27, 7)
...
SWEP.ShootSound               = { "WeaponARC9_P320_Fire" }
SWEP.LayerSound               = { "WeaponARC9_GLOCK_TailOutdoor" }
SWEP.ShootSoundIndoor         = { "WeaponARC9_P320_Fire" }
SWEP.LayerSoundIndoor         = { "WeaponARC9_GLOCK_TailIndoor" }
SWEP.ShootSoundSilenced       = { "WeaponARC9_P320_FireSilenced" } 
SWEP.ShootSoundSilencedIndoor = { "WeaponARC9_P320_FireSilenced" }
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        FireASAP = true,
		EventTable = {
            {s = "WeaponARC9_P320_MagPouchDown", t = 0 / 30},
			{s = "WeaponARC9_P320_MagOut", t = 13 / 30},
			{s = "WeaponARC9_P320_MagHit", t = 29 / 30},
			{s = "WeaponARC9_P320_MagIn", t = 30 / 30},
            {s = "WeaponARC9_P320_MagPouchUp", t = 45 / 30},
        },
		IKTimeLine = {
		            {
                t = 0,
	...
	["reload_empty"] = {
		...
		EventTable = {
			...
			{s = "WeaponARC9_P320_EmptyMagOut", t = 0 / 30},
			{s = "WeaponARC9_GLOCK_EmptyMagPouch", t = 10 / 30},
			{s = "WeaponARC9_P320_EmptyMagIn", t = 26 / 30},
			{s = "WeaponARC9_P320_EmptyBolt", t = 55 / 30},
        },
		IKTimeLine = {
		            {
                t = 0,
    ...
    ["inspect_look"] = {
        ...
        FireASAP = true,
		EventTable = {
            {s = "WeaponARC9_P320_InspectRotate", t = 0 / 30},

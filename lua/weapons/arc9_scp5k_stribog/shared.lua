...
SWEP.CustomSelectIcon = Material("vgui/hud/arc9_scp5k_stribog")
-------------------------------------------------------------------------------------------------------
-- Define Base ----------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------
SWEP.Base = "arc9_base"
...
-------------------------------------------------------------------------------------------------------
SWEP.PrintName = "Stribog SP9A3"
SWEP.TrueName = "Stribog SP9A3"
...
SWEP.Description = [[The Stribog SP9A3 is a versatile and compact submachine gun designed for law enforcement and personal defense, featuring a lightweight design and compatibility with various accessories.]]

-------------------------------------------------------------------------------------------------------
-- Viewmodel & Worldmodel -----------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------
SWEP.ViewModel = "models/weapons/arc9_scp5k/stribog/v_stribog.mdl"
SWEP.UseHands = true

SWEP.WorldModel = "models/weapons/w_pist_usp.mdl"
SWEP.MirrorVMWM = true 
 SWEP.WorldModelOffset = {
     Pos = Vector(-1, 4, -8), -- non tpik (while on ground, on npc etc)
     Ang = Angle(0, 0, 180),
     TPIKPos = Vector(-5, 4, -4), -- arc9_tpik 1, you can make cool poses with it
...
SWEP.RangeMin = 1590 -- How far bullets retain their maximum damage for.
SWEP.RangeMax = 4527.5 -- In Hammer units, how far bullets can travel before dealing DamageMin.
SWEP.Distance = 33000 -- In Hammer units, how far bullets can travel, period.

SWEP.AlwaysPhysBullet = false
SWEP.NeverPhysBullet = false

SWEP.PhysBulletMuzzleVelocity = 14950 -- Physical bullet muzzle velocity in Hammer Units/second. 1 HU != 1 inch.
...
SWEP.RecoilUp = 6  -- Multiplier for vertical recoil 3
SWEP.RecoilSide = 0  -- Multiplier for vertical recoil

SWEP.RecoilRandomUp = 1 -- 1
SWEP.RecoilRandomSide = 3 -- 2
...
SWEP.VisualRecoilUp = 300.0 -- Vertical tilt for visual recoil.F
SWEP.VisualRecoilUpAddSighted = -400.0
SWEP.VisualRecoilSide = 2 -- Horizontal tilt for visual recoil.
SWEP.VisualRecoilRoll = 300.0 -- Roll tilt for visual recoil.

SWEP.VisualRecoilPunch = 250 -- How far back visual recoil moves the gun.
...
SWEP.ActivePos = Vector(-0.5, 2, 0.8)
...
SWEP.ShootSound               = { "WeaponARC9_STRIBOG_Fire" }
SWEP.LayerSound               = { "WeaponARC9_STRIBOG_TailOutdoor" }
SWEP.ShootSoundIndoor         = { "WeaponARC9_STRIBOG_Fire" }
SWEP.LayerSoundIndoor         = { "WeaponARC9_STRIBOG_TailIndoor" }
SWEP.ShootSoundSilenced       = { "WeaponARC9_STRIBOG_FireSilenced" } 
SWEP.ShootSoundSilencedIndoor = { "WeaponARC9_STRIBOG_FireSilenced" }
...
SWEP.Attachments = {
   ...
   },
    {
        PrintName = "Sights",
        Bone = "weapon",
        Pos = Vector(-0, -2.1, 1.7),
        Ang = Angle(0, 90, -0),
        Category = {"csgo_optic", "scp5k_optic", "cod2019_optic"},
		InstalledElements = {"sights_down_stribog"},
		UnInstalledElements = {"sights_up_stribog"},
		InstallSound = "Generic_Sight_LargeAttach",
		UninstallSound = "Generic_Sight_LargeDetach",
        CorrectiveAng = Angle(-1.45, -0.6, 0),
		Scale = 1,
    },
    {
        PrintName = "Ammo",
...
SWEP.Animations = {
	...
	["reload_empty"] = {
		...
		EventTable = {
            {s = "Generic_ClothEquip", t = 0 / 30},
			{s = "WeaponARC9_STRIBOG_MagOutEmpty", t = 0 / 30},
			{s = "WeaponARC9_STRIBOG_MagInEmpty", t = 35 / 30},
			{s = "WeaponARC9_STRIBOG_BoltEmpty", t = 60 / 30},
        },
		IKTimeLine = {
            {
                t = 0,
    ...
    ["inspect_look"] = {
        ...
        FireASAP = true,
		EventTable = {
            {s = "WeaponARC9_STRIBOG_Rotate", t = 0 / 30},
			{s = "WeaponARC9_STRIBOG_BoltBack", t = 68 / 30},
			{s = "WeaponARC9_STRIBOG_BoltForward", t = 90 / 30},

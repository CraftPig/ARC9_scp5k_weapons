...
SWEP.CustomSelectIcon = Material("vgui/hud/arc9_scp5k_ak105")
-------------------------------------------------------------------------------------------------------
-- Define Base ----------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------
SWEP.Base = "arc9_base"
...
SWEP.Description = [[The AK-105 is a compact variant of the AK-74M rifle, optimized for close quarters combat and tactical use. It fires the 5.45×39mm cartridge, offering reduced recoil and better control in rapid-fire situations. Its compact size and light weight make it suitable for urban operations and special forces missions.]]

-------------------------------------------------------------------------------------------------------
-- Viewmodel & Worldmodel -----------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------
SWEP.ViewModel = "models/weapons/arc9_scp5k/ak105/v_ak105.mdl"
SWEP.UseHands = true
...
SWEP.SprintPos = Vector(-0.5, -1, -2.3)
SWEP.SprintAng = Angle(35, -0, -35)
...
SWEP.ShootSound               = { "WeaponARC9_AK74M_Fire" }
SWEP.LayerSound               = { "WeaponARC9_AK556_Outdoors" }
SWEP.ShootSoundIndoor         = { "WeaponARC9_AK74M_Fire" }
SWEP.LayerSoundIndoor         = { "WeaponARC9_AK556_Indoors" }
SWEP.ShootSoundSilenced       = { "WeaponARC9_AK74M_FireSilenced" } 
SWEP.ShootSoundSilencedIndoor = { "WeaponARC9_AK74M_FireSilenced" }
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        FireASAP = true,
		EventTable = {
            {s = "WeaponARC9_AK74M_MagStart", t = 0 / 30},
			{s = "WeaponARC9_AK74M_MagOut", t = 10 / 30},
			{s = "WeaponARC9_AK74M_MagPouchDown", t = 25 / 30},
            {s = "WeaponARC9_AK74M_MagIn", t = 60 / 30},
			{s = "WeaponARC9_AK74M_MagPouchUp", t = 74 / 30},
        },
		IKTimeLine = {
            {
                t = 0,
	...
	["reload_empty"] = {
        ...
        FireASAP = true,
		EventTable = {
            {s = "WeaponARC9_AK74M_EmptyStart", t = 0 / 30},
			{s = "WeaponARC9_AK74M_EmptyMagPouchDown", t = 0 / 30},
			{s = "WeaponARC9_AK74M_EmptyMagOut", t = 12 / 30},
			{s = "WeaponARC9_AK74M_EmptyMagIn", t = 32 / 30},
			{s = "WeaponARC9_AK74M_EmptyBolt", t = 52 / 30},
			{s = "WeaponARC9_AK74M_EmptyMagPouchUp", t = 62 / 30},
        },
		IKTimeLine = {
            {
                t = 0,
    ...
    ["inspect_look"] = {
        ...
        FireASAP = true,
		EventTable = {
            {s = "WeaponARC9_AK74M_InspectRotate", t = 0 / 30},
			{s = "WeaponARC9_AK74M_BoltBack", t = 64 / 30},
			{s = "WeaponARC9_AK74M_BoltForward", t = 82 / 30},
	...
	["inspect"] = {
        ...
        FireASAP = true,
		EventTable = {
            {s = "WeaponARC9_AK74M_MagCheckOut", t = 0 / 30},
			{s = "WeaponARC9_AK74M_MagCheckIn", t = 75 / 30},
        },
		IKTimeLine = {
            {
                t = 0,

...
SWEP.CustomSelectIcon = Material("vgui/hud/arc9_scp5k_mp5k")
-------------------------------------------------------------------------------------------------------
-- Define Base ----------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------
SWEP.Base = "arc9_base"
...
SWEP.Description = [[The MP5K is a compact variant of the MP5 submachine gun, designed for close-quarters combat and concealed carry. Its compact size and lightweight make it ideal for special operations and personal defense.]]

-------------------------------------------------------------------------------------------------------
-- Viewmodel & Worldmodel -----------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------
SWEP.ViewModel = "models/weapons/arc9_scp5k/mp5k/v_mp5k.mdl"
SWEP.UseHands = true
...
SWEP.MuzzleParticle = { "shellsmoke", "muzzleflash_OTS", "muzzleflash_pistol_cleric" }
...
SWEP.ShootSound               = { "WeaponARC9_MP5K_Fire" }
SWEP.LayerSound               = { "WeaponARC9_MP5_TailOutdoor" }
SWEP.ShootSoundIndoor         = { "WeaponARC9_MP5K_Fire" }
...
SWEP.Animations = {
    ...
    ["reload"] = {
		...
		EventTable = {
			...
			{s = "WeaponARC9_MP5K_MagOut", t = 0 / 30},
			{s = "WeaponARC9_MP5K_Rotate", t = 50 / 30},
			{s = "WeaponARC9_MP5K_MagIn", t = 70 / 30},
			{s = "WeaponARC9_MP5_Equip", t = 95 / 30},
        },
		IKTimeLine = {
            {
                t = 0,
	...
	["reload_empty"] = {
		...
		EventTable = {
            {s = "Generic_ClothEquip", t = 0 / 30},
			{s = "WeaponARC9_MP5K_BoltBackEmpty", t = 0 / 30},
			{s = "WeaponARC9_MP5K_MagOutEmpty", t = 32 / 30},
			{s = "WeaponARC9_MP5_MagPouchEmpty", t = 45 / 30},
			{s = "WeaponARC9_MP5K_MagInEmpty", t = 80 / 30},
			{s = "WeaponARC9_MP5K_BoltForwardEmpty", t = 105 / 30},
        },
		IKTimeLine = {
            {
                t = 0,
    ...
    ["inspect_look"] = {
        ...
        FireASAP = true,
		EventTable = {
            {s = "WeaponARC9_MP5K_Rotate", t = 0 / 30},
			{s = "WeaponARC9_MP5K_BoltBack", t = 80 / 30},
			{s = "WeaponARC9_MP5K_BoltForward", t = 105 / 30},
            {s = "Generic_ClothEquip", t = 120 / 30},
        },
		IKTimeLine = {
            {
                t = 0,
	...
	["inspect"] = {
        ...
        FireASAP = true,
		EventTable = {
            {s = "WeaponARC9_MP5K_MagCheckOut", t = 0 / 30},
			{s = "WeaponARC9_MP5K_MagCheckIn", t = 65 / 30},
        },
		IKTimeLine = {
            {
                t = 0,

...
SWEP.CustomSelectIcon = Material("vgui/hud/arc9_scp5k_asval")
-------------------------------------------------------------------------------------------------------
-- Define Base ----------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------
SWEP.Base = "arc9_base"
...
-------------------------------------------------------------------------------------------------------
SWEP.ViewModel = "models/weapons/arc9_scp5k/asval/legacy/v_asval.mdl"
SWEP.UseHands = true
...
SWEP.IronSights = {
    Pos = Vector(-2.4, 1, 1.65),
    Ang = Angle(-0.15, 0.9, 0),
    Magnification = 1.1,
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        FireASAP = true,
		EventTable = {
            {s = "WeaponARC9_ASVAL_MagPouchUp", t = 0 / 30},
			{s = "WeaponARC9_ASVAL_MagOut", t = 20 / 30},
			{s = "WeaponARC9_ASVAL_MagIn", t = 32 / 30},
            {s = "WeaponARC9_ASVAL_MagPouchDown", t = 45 / 30},
			{s = "WeaponARC9_ASVAL_HandlingBarrel", t = 70 / 30},
        },
		IKTimeLine = {
            {
                t = 0,
	...
	["reload_empty"] = {
		...
		EventTable = {
            {s = "Generic_ClothEquip", t = 0 / 30},
			{s = "WeaponARC9_ASVAL_EmptyMagOut", t = 10 / 30},
			{s = "WeaponARC9_ASVAL_EmptyMagIn", t = 30 / 30},
			{s = "WeaponARC9_ASVAL_EmptyBoltBack", t = 58 / 30},
			{s = "WeaponARC9_ASVAL_EmptyBoltForward", t = 63 / 30},
        },
		IKTimeLine = {
            {
                t = 0,
    ...
    ["inspect_look"] = {
        ...
        FireASAP = true,
		EventTable = {
            {s = "WeaponARC9_ASVAL_InspectRotate", t = 0 / 30},
			{s = "WeaponARC9_ASVAL_BoltBack", t = 36 / 30},
			{s = "WeaponARC9_ASVAL_BoltForward", t = 80 / 30},
            {s = "WeaponARC9_ASVAL_HandlingBarrel", t = 90 / 30},
        },
		IKTimeLine = {
            {
                t = 0,
	...
	["inspect"] = {
        ...
        FireASAP = true,
		EventTable = {
            {s = "WeaponARC9_ASVAL_MagCheckOut", t = 0 / 30},
			{s = "WeaponARC9_ASVAL_MagCheckIn", t = 55 / 30},
        },
		IKTimeLine = {
            {
                t = 0,

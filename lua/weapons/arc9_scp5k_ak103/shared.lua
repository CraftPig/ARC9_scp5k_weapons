...
SWEP.CustomSelectIcon = Material("vgui/hud/arc9_scp5k_ak103")
-------------------------------------------------------------------------------------------------------
-- Define Base ----------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------
SWEP.Base = "arc9_base"
...
SWEP.Description = [[The AK-103 is a modernized variant of the AK-47/AKM series of rifles, chambered for the 7.62×39mm cartridge. It features improved ergonomics and compatibility with various accessories, while retaining the renowned reliability of its predecessors.]]

-------------------------------------------------------------------------------------------------------
-- Viewmodel & Worldmodel -----------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------
SWEP.ViewModel = "models/weapons/arc9_scp5k/ak103/v_ak103.mdl"
SWEP.UseHands = true

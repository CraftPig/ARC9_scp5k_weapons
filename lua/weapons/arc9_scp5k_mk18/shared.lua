...
--------------------------
---- Weapon Recoil
SWEP.Recoil = 0.65 -- General recoil multiplier
...
SWEP.SprintPos = Vector(-0.75, -1, -1.5)
...
SWEP.Animations = {
    ...
    ["reload"] = {
		...
		EventTable = {
            ...
            {s = "WeaponARC9_MK18_MagPouch", t = 49 / 30},
	...
	["reload_empty"] = {
		...
		EventTable = {
			...
			{s = "WeaponARC9_MK18_EmptyMagIn", t = 25 / 30},

...
-------------------------------------------------------------------------------------------------------
SWEP.PrintName = "SA-58 OSW"
SWEP.TrueName = "SA-58 OSW"
...
SWEP.Description = [[The SA58 OSW is a compact, select-fire rifle based on the FN FAL design. It is often associated with DS Arms, an American manufacturer, and features a short barrel, selective fire modes, and is chambered for the 7.62x51mm NATO cartridge.]]

-------------------------------------------------------------------------------------------------------
-- Viewmodel & Worldmodel -----------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------
SWEP.ViewModel = "models/weapons/arc9_scp5k/sa58/v_sa58.mdl"
SWEP.UseHands = true
...
SWEP.DamageMin = 17.5 -- Damage done at maximum range
...
SWEP.PhysBulletMuzzleVelocity = 31190 -- Physical bullet muzzle velocity in Hammer Units/second. 1 HU != 1 inch.
...
SWEP.MuzzleParticle = { "shellsmoke", "muzzleflash_OTS", "muzzleflash_m14" }
...
SWEP.ActivePos = Vector(0.4, -0.0, 1)
SWEP.ActiveAng = Angle(-0.0, 2, -2)
...
SWEP.ShootSound               = { "WeaponARC9_SA58_Fire" }
SWEP.LayerSound               = { "WeaponARC9_MK17_Outdoor" }
SWEP.ShootSoundIndoor         = { "WeaponARC9_SA58_Fire" }
SWEP.LayerSoundIndoor         = { "WeaponARC9_MK17_Indoor" }
SWEP.ShootSoundSilenced       = { "WeaponARC9_SA58_FireSilenced" } 
SWEP.ShootSoundSilencedIndoor = { "WeaponARC9_SA58_FireSilenced" }
...
SWEP.Animations = {
	...
	["reload_empty"] = {
		...
		EventTable = {
            {s = "Generic_ClothEquip", t = 0 / 30},
			{s = "WeaponARC9_SA58_EmptyMagPouch", t = 0 / 30},
			{s = "WeaponARC9_SA58_EmptyMagOut", t = 12 / 30},
			{s = "WeaponARC9_SA58_EmptyMagIn", t = 39 / 30},
			{s = "WeaponARC9_SA58_EmptyBolt", t = 65 / 30},
        },
		IKTimeLine = {
            {
                t = 0,

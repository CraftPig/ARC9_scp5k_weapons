...
SWEP.Description = [[The SG553R is a compact, reliable assault rifle designed for enhanced accuracy and performance.]]

-------------------------------------------------------------------------------------------------------
-- Viewmodel & Worldmodel -----------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------
SWEP.ViewModel = "models/weapons/arc9_scp5k/sig/v_sig762.mdl"
SWEP.UseHands = true
...
SWEP.VisualRecoilSpringPunchDampingAddSighted = -2
...
SWEP.ShootSound               = { "WeaponARC9_SIG762_Fire" }
SWEP.LayerSound               = { "WeaponARC9_SIG556_TailOutdoor" }
SWEP.ShootSoundIndoor         = { "WeaponARC9_SIG762_Fire" }
SWEP.LayerSoundIndoor         = { "WeaponARC9_MK18_Indoors" }
SWEP.ShootSoundSilenced       = { "WeaponARC9_SIG762_FireSilenced" } 
SWEP.ShootSoundSilencedIndoor = { "WeaponARC9_SIG762_FireSilenced" }
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        FireASAP = true,
		EventTable = {
            {s = "WeaponARC9_SIG762_ReloadStart", t = 0 / 30},
			{s = "WeaponARC9_AK74M_MagPouchDown", t = 5 / 30},
			{s = "WeaponARC9_SIG762_MagOut", t = 17 / 30},
            {s = "WeaponARC9_SIG762_MagIn", t = 35 / 30},
        },
		IKTimeLine = {
            {
                t = 0,
	...
	["reload_empty"] = {
		...
		EventTable = {
		    ...
		    {s = "WeaponARC9_SIG762_EmptyMagOut", t = 20 / 30},
			{s = "WeaponARC9_SIG762_EmptyMagIn", t = 45 / 30},
		    {s = "WeaponARC9_SIG762_EmptyBolt", t = 75 / 30},
        },
		IKTimeLine = {
            {
                t = 0,

...
SWEP.CustomSelectIcon = Material("vgui/hud/arc9_scp5k_realasval")
-------------------------------------------------------------------------------------------------------
-- Define Base ----------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------
SWEP.Base = "arc9_base"
...
SWEP.Description = [[The AS Val is a compact, integrally suppressed assault rifle designed in the Soviet Union, firing the 9x39mm cartridge. Known for its special forces applications, the AS Val combines a compact design with a built-in suppressor, offering stealth and versatility in close-quarters operations.]]

-------------------------------------------------------------------------------------------------------
-- Viewmodel & Worldmodel -----------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------
SWEP.ViewModel = "models/weapons/arc9_scp5k/asval/v_asval.mdl"
SWEP.UseHands = true
...
SWEP.RangeMax = 6874 -- In Hammer units, how far bullets can travel before dealing DamageMin.
SWEP.Distance = 33000 -- In Hammer units, how far bullets can travel, period.

SWEP.AlwaysPhysBullet = false
SWEP.NeverPhysBullet = false

SWEP.PhysBulletMuzzleVelocity = 11800 -- Physical bullet muzzle velocity in Hammer Units/second. 1 HU != 1 inch.
...
SWEP.MuzzleParticle = { "shellsmoke", "muzzleflash_OTS", "muzzleflash_suppressed" }
...
SWEP.IronSights = {
    Pos = Vector(-2.05, -2, 1.46),
    Ang = Angle(-0.15, 0.7, 0),
    Magnification = 1.1,
...
SWEP.ActivePos = Vector(-0.1, 2.0, 0)
SWEP.ActiveAng = Angle(-0.0, 5, -5)
...
SWEP.ShootSound               = { "WeaponARC9_ASVAL_Fire" }
SWEP.LayerSound               = { "WeaponARC9_SMG_TailOutdoor" }
SWEP.ShootSoundIndoor         = { "WeaponARC9_ASVAL_Fire" }
SWEP.LayerSoundIndoor         = { "WeaponARC9_SMG_TailIndoor" }
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        FireASAP = true,
		EventTable = {
            {s = "WeaponARC9_VSS_MagPouchDown", t = 0 / 30},
			{s = "WeaponARC9_AK103_MagOut", t = 20 / 30},
			{s = "WeaponARC9_VSS_MagPouchDown", t = 40 / 30},
			{s = "WeaponARC9_AK103_MagIn", t = 40 / 30},
            {s = "WeaponARC9_VSS_MagPouchUp", t = 55 / 30},
			{s = "WeaponARC9_ASVAL_HandlingBarrel", t = 74 / 30},
        },
		IKTimeLine = {
            {
                t = 0,
	...
	["reload_empty"] = {
        ...
        FireASAP = true,
		EventTable = {
            {s = "WeaponARC9_VSS_EmptyMagPouch", t = 0 / 30},
			{s = "WeaponARC9_AK103_EmptyMagOut", t = 13 / 30},
			{s = "WeaponARC9_AK103_EmptyMagIn", t = 34 / 30},
			{s = "WeaponARC9_VSS_EmptyBolt", t = 53 / 30},
			{s = "WeaponARC9_VSS_EmptyMagPouchDown", t = 65 / 30},
			{s = "WeaponARC9_ASVAL_HandlingBarrel", t = 78 / 30},
        },
		IKTimeLine = {
            {
                t = 0,
    ...
    ["inspect_look"] = {
		...
		EventTable = {
			...
			{s = "WeaponARC9_VSS_EmptyBoltBack", t = 83 / 30},
			{s = "WeaponARC9_VSS_EmptyBoltForward", t = 115 / 30},
            {s = "WeaponARC9_ASVAL_HandlingBarrel", t = 130 / 30},
        },
		IKTimeLine = {
            {
                t = 0,

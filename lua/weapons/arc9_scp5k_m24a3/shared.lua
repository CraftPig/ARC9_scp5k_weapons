...
SWEP.CustomSelectIcon = Material("vgui/hud/arc9_scp5k_m24a3")
-------------------------------------------------------------------------------------------------------
-- Define Base ----------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------
SWEP.Base = "arc9_base"
...
SWEP.Description = [[The M24A3 is a precision bolt-action sniper rifle designed for long-range shooting and military applications. It features a robust construction, adjustable stock, and capable of delivering accurate fire at extended ranges.]]

-------------------------------------------------------------------------------------------------------
-- Viewmodel & Worldmodel -----------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------
SWEP.ViewModel = "models/weapons/arc9_scp5k/m24a3/v_m24a3.mdl"
SWEP.UseHands = true
...
SWEP.Penetration = 35 -- Units of wood that can be penetrated by this gun.
...
SWEP.RangeMin = 3920 -- How far bullets retain their maximum damage for.
...
SWEP.PhysBulletMuzzleVelocity = 38760 -- Physical bullet muzzle velocity in Hammer Units/second. 1 HU != 1 inch.
...
SWEP.RecoilUp = 20  -- Multiplier for vertical recoil
...
SWEP.VisualRecoilPunch = 400 -- How far back visual recoil moves the gun.
...
SWEP.BarrelLength = 50 -- Distance for nearwalling
...
SWEP.MuzzleParticle = { "shellsmoke", "muzzleflash_OTS", "muzzleflash_SR25" }
...
SWEP.ShootSound               = { "WeaponARC9_m24a3_Fire" }
SWEP.LayerSound               = { "WeaponARC9_M24A3Outdoor" }
SWEP.ShootSoundIndoor         = { "WeaponARC9_m24a3_Fire" }
SWEP.LayerSoundIndoor         = { "WeaponARC9_M24A3Indoor" }
SWEP.ShootSoundSilenced       = { "WeaponARC9_m24a3_FireSilenced" } 
SWEP.ShootSoundSilencedIndoor = { "WeaponARC9_m24a3_FireSilenced" }
...
SWEP.Animations = {
    ...
    ["draw"] = {
        ...
        FireASAP = true,
		EventTable = {
            {s = "WeaponARC9_m24a3_Equip", t = 0 / 30},
	...
	["holster"] = {
        ...
        FireASAP = true,
		EventTable = {
            {s = "WeaponARC9_m24a3_Unequip", t = 0 / 30},
	...
	["cycle"] = {
        ...
        FireASAP = true,
		EventTable = {
		    {s = "WeaponARC9_m24a3_Action", t = 0 / 30},
        },
    },
    ["reload"] = {
        Source = {"reload"},
        ...
        FireASAP = false,
		EventTable = {
		    {s = "WeaponARC9_m24a3_MagOut", t = 0 / 30},
	...
	["reload_empty"] = {
        ...
        FireASAP = false,
		EventTable = {
			{s = "WeaponARC9_m24a3_EmptyMagOut", t = 0 / 30},
			{s = "WeaponARC9_m24a3_EmptyMagPouch", t = 15 / 30},
			{s = "WeaponARC9_m24a3_EmptyMagIn", t = 55 / 30},
			{s = "WeaponARC9_m24a3_EmptyBolt", t = 80 / 30},
    ...
    ["inspect_look"] = {
        ...
        FireASAP = true,
		EventTable = {
            {s = "WeaponARC9_m24a3_Rotate", t = 0 / 30},
			{s = "WeaponARC9_m24a3_BoltBack", t = 45 / 30},
			{s = "WeaponARC9_m24a3_BoltForward", t = 70 / 30},
	...
	["inspect"] = {
        ...
        FireASAP = true,
		EventTable = {
            {s = "WeaponARC9_m24a3_MagCheckOut", t = 0 / 30},

...
SWEP.CustomSelectIcon = Material("vgui/hud/arc9_scp5k_mp5sd")
-------------------------------------------------------------------------------------------------------
-- Define Base ----------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------
SWEP.Base = "arc9_base"
...
SWEP.Description = [[The MP5SD is a specialized variant of the MP5 submachine gun featuring an integrated suppressor, designed for covert operations where reduced noise signature is essential.]]

-------------------------------------------------------------------------------------------------------
-- Viewmodel & Worldmodel -----------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------
SWEP.ViewModel = "models/weapons/arc9_scp5k/mp5sd/v_mp5sd.mdl"
SWEP.UseHands = true
...
SWEP.RangeMax = 3543.3 -- In Hammer units, how far bullets can travel before dealing DamageMin.
SWEP.Distance = 33000 -- In Hammer units, how far bullets can travel, period.

SWEP.AlwaysPhysBullet = false
SWEP.NeverPhysBullet = false

SWEP.PhysBulletMuzzleVelocity = 12590 -- Physical bullet muzzle velocity in Hammer Units/second. 1 HU != 1 inch.
...
SWEP.SpreadAddRecoil = 0.00 -- Applied per unit of recoil.
...
SWEP.ShootSound               = { "WeaponARC9_MP5SD_Fire" }
SWEP.LayerSound               = { "WeaponARC9_SMG_TailOutdoor" }
SWEP.ShootSoundIndoor         = { "WeaponARC9_MP5SD_Fire" }
SWEP.LayerSoundIndoor         = { "WeaponARC9_SMG_TailIndoor" }
SWEP.ShootSoundSilenced       = { "WeaponARC9_MP5SD_Fire" } 
SWEP.ShootSoundSilencedIndoor = { "WeaponARC9_MP5SD_Fire" }
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        FireASAP = true,
		EventTable = {
            {s = "WeaponARC9_MP5SD_MagPouch", t = 0 / 30},
			{s = "WeaponARC9_MP5SD_MagOut", t = 0 / 30},
			{s = "WeaponARC9_MP5SD_MagIn", t = 48 / 30},
            {s = "WeaponARC9_MP5SD_MagHit", t = 73 / 30},
	...
	["reload_empty"] = {
		...
		EventTable = {
            {s = "Generic_ClothEquip", t = 0 / 30},
			{s = "WeaponARC9_MP5SD_BoltBackEmpty", t = 0 / 30},
			{s = "WeaponARC9_MP5SD_MagOutEmpty", t = 22 / 30},
			{s = "WeaponARC9_MP5_MagPouchEmpty", t = 36 / 30},
			{s = "WeaponARC9_MP5SD_MagInEmpty", t = 55 / 30},
			{s = "WeaponARC9_MP5SD_BoltForwardEmpty", t = 83 / 30},
        },
		IKTimeLine = {
            {
                t = 0,

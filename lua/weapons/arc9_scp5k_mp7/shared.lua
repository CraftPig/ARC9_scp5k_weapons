...
SWEP.CustomSelectIcon = Material("vgui/hud/arc9_scp5k_mp7")
-------------------------------------------------------------------------------------------------------
-- Define Base ----------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------
SWEP.Base = "arc9_base"
...
SWEP.Description = [[The MP7 is a compact, lightweight submachine gun designed by Heckler & Koch. It's favored by special forces and law enforcement for its versatility, firepower, and ease of handling in close-quarters combat.]]

-------------------------------------------------------------------------------------------------------
-- Viewmodel & Worldmodel -----------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------
SWEP.ViewModel = "models/weapons/arc9_scp5k/mp7/v_mp7.mdl"
SWEP.UseHands = true

SWEP.WorldModel = "models/weapons/w_pist_usp.mdl"
SWEP.MirrorVMWM = true 
 SWEP.WorldModelOffset = {
     Pos = Vector(-7, 4, -6.5), -- non tpik (while on ground, on npc etc)
     Ang = Angle(0, 0, 180),
     TPIKPos = Vector(-15, 1, -3), -- arc9_tpik 1, you can make cool poses with it
...
SWEP.PhysBulletMuzzleVelocity = 27550 -- Physical bullet muzzle velocity in Hammer Units/second. 1 HU != 1 inch.
...
SWEP.ShootSound               = { "WeaponARC9_MP7_Fire" }
SWEP.LayerSound               = { "WeaponARC9_MP5_TailOutdoor" }
SWEP.ShootSoundIndoor         = { "WeaponARC9_MP7_Fire" }
SWEP.LayerSoundIndoor         = { "WeaponARC9_MP5_TailIndoor" }
SWEP.ShootSoundSilenced       = { "WeaponARC9_MP7_FireSilenced" } 
SWEP.ShootSoundSilencedIndoor = { "WeaponARC9_MP7_FireSilenced" }
...
SWEP.Attachments = {
    ...
    },
    {
        ...
        CorrectiveAng = Angle(-0.1, 0.51, 0),
		Scale = 1,
    },
	{
        PrintName = "Grip",
    ...
    },
	{
        ...
        Bone = "weapon",
        Pos = Vector(-0, -4.5, -0.9),
        Ang = Angle(0, 90, -0),
		Scale = 1,
    },
	{
        PrintName = "Stock",
        Category = "scp5k_mp7stock",
		InstallSound = "Generic_Barrel_SmallAttach",
		UninstallSound = "Generic_Barrel_SmallDetach",
		UnInstalledElements = {"stock_extended_mp7"},
        Bone = "stock",
        Pos = Vector(-0, -8, -0.0),
        Ang = Angle(0, 90, -0),
		Scale = 1,
    ...
    {
        PrintName = "Cosmetic",
        Category = {"universal_camo", "scp5k_mp7_skin"},
        CosmeticOnly = true,
    },
}
...
SWEP.Animations = {
    ...
    ["inspect_look"] = {
        ...
        FireASAP = true,
		EventTable = {
            {s = "WeaponARC9_MP7_Rotate", t = 0 / 30},
			{s = "WeaponARC9_MP7_BoltBack", t = 50 / 30},
			{s = "WeaponARC9_MP7_BoltForward", t = 75 / 30},
            {s = "Generic_ClothEquip", t = 82 / 30},
        },
		IKTimeLine = {
            {
                t = 0,
	...
	["inspect"] = {
        ...
        FireASAP = true,
		EventTable = {
            {s = "WeaponARC9_MP7_MagCheckOut", t = 0 / 30},
			{s = "WeaponARC9_MP7_MagCheckIn", t = 65 / 30},
        },
		IKTimeLine = {
            {
                t = 0,

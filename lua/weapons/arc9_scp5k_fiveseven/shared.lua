...
SWEP.Animations = {
    ...
    ["inspect"] = {
		...
		EventTable = {
			...
			{s = "WeaponARC9_FiveSeveN_BoltBack", t = 60 / 30},
			{s = "WeaponARC9_FiveSeveN_BoltForward", t = 80 / 30},
            {s = "WeaponARC9_FiveSeveN_BoltHit", t = 98/ 30},
        },
    },
	["inspect_empty"] = {
		...
		EventTable = {
			...
			{s = "WeaponARC9_FiveSeveN_MagCheckIn", t = 48 / 30},
        },
    },
    ["idle_sprint"] = {
        Source = {"sprint"},

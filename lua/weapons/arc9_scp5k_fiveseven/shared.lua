...
SWEP.CustomSelectIcon = Material("vgui/hud/arc9_scp5k_fiveseven")
-------------------------------------------------------------------------------------------------------
-- Define Base ----------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------
SWEP.Base = "arc9_base"
...
SWEP.TrueName = "FN Five-seveN Mark. 2"
...
SWEP.Description = [[The FN Five-seveN Mark II is a lightweight, semi-automatic pistol with a unique 5.7x28mm caliber. Recognized for low recoil, high capacity, and reliable performance, it's a favorite among military and law enforcement.]]

-------------------------------------------------------------------------------------------------------
-- Viewmodel & Worldmodel -----------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------
SWEP.ViewModel = "models/weapons/arc9_scp5k/fiveseven/v_fiveseven.mdl"
SWEP.UseHands = true
...
SWEP.MirrorVMWM = true 
 SWEP.WorldModelOffset = {
     ...
     Ang = Angle(0, 0, 180),
     TPIKPos = Vector(-15, 0, -5), -- arc9_tpik 1, you can make cool poses with it
...
SWEP.RangeMax = 3550 -- In Hammer units, how far bullets can travel before dealing DamageMin.
...
SWEP.RecoilRandomSide = 6
SWEP.RecoilRandomSideAddSighted = -3
...
SWEP.ActivePos = Vector(-3.1, -5.5, 0.25)
SWEP.ActiveAng = Angle(-1, 1, -9)
...
SWEP.ShootSound               = { "WeaponARC9_FiveSeveN_Fire" }
SWEP.LayerSound               = { "WeaponARC9_GLOCK_TailOutdoor" }
SWEP.ShootSoundIndoor         = { "WeaponARC9_FiveSeveN_Fire" }
SWEP.LayerSoundIndoor         = { "WeaponARC9_GLOCK_TailIndoor" }
SWEP.ShootSoundSilenced       = { "WeaponARC9_FiveSeveN_FireSilenced" } 
SWEP.ShootSoundSilencedIndoor = { "WeaponARC9_FiveSeveN_FireSilenced" }
...
SWEP.Attachments = {
    ...
    },
    {
		...
		InstallSound = "Generic_Grip_SmallAttach",
		UninstallSound = "Generic_Grip_SmallDetach",
		Icon_Offset = Vector(0.4, 0, 1.5),
    },
    {
        PrintName = "Sights",
        Bone = "Slide",
        Pos = Vector(0, 0.5, 0.35),
        Ang = Angle(0, 90, -0),
        Category = {"csgo_optics_pistols_alt","eft_optic_small"},
        CorrectiveAng = Angle(-0.0, 0.0, 0),
		InstallSound = "Generic_Sight_SmallAttach",
		UninstallSound = "Generic_Sight_SmallDetach",
		Scale = 0.8,
    },
    {
        PrintName = "Tactical",
        ...
        Ang = Angle(0, 90, 0),
		InstallSound = "Generic_Light_SmallAttach",
		UninstallSound = "Generic_Light_SmallDetach",
		Scale = 1.1,
    },
    {
        PrintName = "Ammo",
    ...
    {
        PrintName = "Cosmetic",
        Category = {"universal_camo", "scp5k_fiveseven_skin"},
        CosmeticOnly = true,
    },
	{
        PrintName = "View",
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        FireASAP = true,
		EventTable = {
            {s = "WeaponARC9_FiveSeveN_MagPouchUp", t = 0 / 30},
			{s = "WeaponARC9_FiveSeveN_MagOut", t = 10 / 30},
			{s = "WeaponARC9_FiveSeveN_MagIn", t = 31 / 30},
			{s = "WeaponARC9_FiveSeveN_MagPouchDown", t = 45 / 30},
	...
	["reload_empty"] = {
		...
		EventTable = {
			...
			{s = "WeaponARC9_FiveSeveN_EmptyMagOut", t = 0 / 30},
			{s = "WeaponARC9_FiveSeveN_EmptyMagPouchDown", t = 10 / 30},
			{s = "WeaponARC9_FiveSeveN_EmptyMagIn", t = 30 / 30},
			{s = "WeaponARC9_FiveSeveN_EmptyBolt", t = 52 / 30},
        },
    },
    --------------------------------------------------- Tacticool
    ["inspect_look"] = {
        ...
        FireASAP = true,
		EventTable = {
            {s = "WeaponARC9_FiveSeveN_InspectRotate", t = 0 / 30},
			{s = "WeaponARC9_FiveSeveN_BoltBack", t = 65 / 30},
			{s = "WeaponARC9_FiveSeveN_BoltForward", t = 85 / 30},
            {s = "WeaponARC9_FiveSeveN_BoltHit", t = 101 / 30},
        },
    },
	["inspect"] = {
        Source = {"magcheck"},
        ...
        FireASAP = true,
		EventTable = {
            {s = "WeaponARC9_FiveSeveN_MagCheckOut", t = 0 / 30},
			{s = "WeaponARC9_FiveSeveN_MagCheckIn", t = 53 / 30},
        },
    },
	["inspect_empty"] = {

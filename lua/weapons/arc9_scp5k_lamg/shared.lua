...
SWEP.ActivePos = Vector(0.4, 2.2, 0)
...
SWEP.Attachments = {
    {
        PrintName = "Muzzle",
        Category = {"muzzle","muzzle_m4", "scp5k_muzzle","cod2019_muzzle"},
    ...
    {
        PrintName = "Cosmetic",
        Category = {"universal_camo", "scp5k_lamg_skin"},
        CosmeticOnly = true,
    },
{ 
        PrintName = "Charm",

...
SWEP.CustomSelectIcon = Material("vgui/hud/arc9_scp5k_sig556")
-------------------------------------------------------------------------------------------------------
-- Define Base ----------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------
SWEP.Base = "arc9_base"
...
SWEP.Description = [[The SG553 is a compact, reliable assault rifle designed for enhanced accuracy and performance.]]

-------------------------------------------------------------------------------------------------------
-- Viewmodel & Worldmodel -----------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------
SWEP.ViewModel = "models/weapons/arc9_scp5k/sig/v_sig556.mdl"
SWEP.UseHands = true
...
SWEP.PhysBulletMuzzleVelocity = 27540 -- Physical bullet muzzle velocity in Hammer Units/second. 1 HU != 1 inch.
...
SWEP.VisualRecoilSpringPunchDampingAddSighted = -3
...
SWEP.IronSights = {
    Pos = Vector(-2.48, 0.0, 2.38),
    Ang = Angle(-0.33, 0.23, 0),
    Magnification = 1,
...
SWEP.ActivePos = Vector(-0.2, 1.1, 1.35)
...
SWEP.ShootSound               = { "WeaponARC9_SIG556_Fire" }
SWEP.LayerSound               = { "WeaponARC9_SIG556_TailOutdoor" }
SWEP.ShootSoundIndoor         = { "WeaponARC9_SIG556_Fire" }
SWEP.LayerSoundIndoor         = { "WeaponARC9_MK18_Indoors" }
SWEP.ShootSoundSilenced       = { "WeaponARC9_SIG556_FireSilenced" } 
SWEP.ShootSoundSilencedIndoor = { "WeaponARC9_SIG556_FireSilenced" }
...
SWEP.Attachments = {
    ...
    },
	{
        ...
        Bone = "weapon",
        InstalledElements = {"stock_sig556_none"},
		InstallSound = "Generic_Grip_LargeAttach",
		UninstallSound = "Generic_Grip_LargeDetach",
        Pos = Vector(-0.0, -0.68, 3),
        Ang = Angle(-90, 90, -0),
        Icon_Offset = Vector(-0, 0, 0),
		Scale = 1.1,
    },
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        FireASAP = true,
		EventTable = {
            {s = "WeaponARC9_SIG556_ReloadStart", t = 0 / 30},
			{s = "WeaponARC9_AK74M_MagPouchDown", t = 5 / 30},
			{s = "WeaponARC9_SIG556_MagOut", t = 20 / 30},
            {s = "WeaponARC9_SIG556_MagIn", t = 37 / 30},
        },
		IKTimeLine = {
            {
                t = 0,
	...
	["reload_empty"] = {
		...
		EventTable = {
            {s = "WeaponARC9_SIG556_ReloadStart", t = 0 / 30},
		    {s = "WeaponARC9_AK74M_EmptyMagPouchDown", t = 5 / 30},
		    {s = "WeaponARC9_SIG556_EmptyMagOut", t = 16 / 30},
			{s = "WeaponARC9_SIG556_EmptyMagIn", t = 45 / 30},
		    {s = "WeaponARC9_SIG556_EmptyBolt", t = 76 / 30},
        },
		IKTimeLine = {
            {
                t = 0,
    ...
    ["inspect"] = {
        ...
        FireASAP = true,
		EventTable = {
            {s = "WeaponARC9_SIG556_MagCheckOut", t = 0 / 30},
			{s = "WeaponARC9_SIG556_MagCheckIn", t = 88 / 30},
        },
		IKTimeLine = {
            {
                t = 0,
	...
	["inspect_look"] = {
        ...
        FireASAP = true,
		EventTable = {
            {s = "WeaponARC9_SIG556_InspectRotate", t = 0 / 30},
			{s = "WeaponARC9_SIG556_BoltBack", t = 92 / 30},
			{s = "WeaponARC9_SIG556_BoltForward", t = 115 / 30},
            {s = "WeaponARC9_SIG556_BoltHit", t = 131 / 30},
        },
		IKTimeLine = {
            {
                t = 0,
	...
	["inspect_empty"] = {
        ...
        FireASAP = true,
		EventTable = {
            {s = "WeaponARC9_SIG762_MagCheckOut", t = 0 / 30},
			{s = "WeaponARC9_SIG762_MagCheckIn", t = 88 / 30},
        },
		IKTimeLine = {
            {
                t = 0,

...
SWEP.CustomSelectIcon = Material("vgui/hud/arc9_scp5k_m1014")
-------------------------------------------------------------------------------------------------------
-- Define Base ----------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------
SWEP.Base = "arc9_base"
...
SWEP.Description = [[The M1014 is a semi-automatic 12-gauge shotgun known for its reliability and effectiveness in military and law enforcement applications.]]

-------------------------------------------------------------------------------------------------------
-- Viewmodel & Worldmodel -----------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------
SWEP.ViewModel = "models/weapons/arc9_scp5k/m1014/v_m1014.mdl"
SWEP.UseHands = true
...
-------------------------------------------------------------------------------------------------------
---- Damage
SWEP.DamageMax = 22,5 -- Damage done at point blank range
SWEP.DamageMin = 2,5 -- Damage done at maximum range
...
SWEP.RangeMax = 2362.1 -- In Hammer units, how far bullets can travel before dealing DamageMin.
...
SWEP.ActivePos = Vector(-0.0, 1.0, 0.7)
...
SWEP.ShootSound               = { "WeaponARC9_M1014_Fire" }
SWEP.LayerSound               = { "WeaponARC9_M1014_TailOutdoor" }
SWEP.ShootSoundIndoor         = { "WeaponARC9_M1014_Fire" }
SWEP.LayerSoundIndoor         = { "WeaponARC9_M1014_TailIndoor" }
SWEP.ShootSoundSilenced       = { "WeaponARC9_M1014_FireSilenced" } 
SWEP.ShootSoundSilencedIndoor = { "WeaponARC9_M1014_FireSilenced" }
...
SWEP.Attachments = {
    {
        ...
        Category = {"muzzle","muzzle_m4","muzzle_snipers","cod2019_muzzle", "scp5k_muzzle_shotgun"},
    ...
    },
	{
        ...
        Category = {"grip","grip_mk18","grip_m4","fas_ubgl","cod2019_grip", "scp5k_foregrip"},
    ...
    },
    {
        ...
        CorrectiveAng = Angle(-0.251, 0.57, 0),
		Scale = 1,
    },
    {
        PrintName = "Tactical",
...
SWEP.Animations = {
    ...
    ["draw"] = {
        ...
        FireASAP = true,
		EventTable = {
            {s = "WeaponARC9_M1014_Equip", t = 0 / 30},
	...
	["holster"] = {
        ...
        FireASAP = true,
		EventTable = {
            {s = "WeaponARC9_M1014_Unequip", t = 0 / 30},
    ...
    ["reload_start"] = {
        ...
        FireASAP = false,
		EventTable = {
		    {s = "WeaponARC9_M1014_ReloadStart", t = 10 / 30},
        },
		IKTimeLine = {
            {
                t = 0,
	...
	["reload_start_empty"] = {
		...
		EventTable = {
            {s = "Generic_ClothEquip", t = 0 / 30},
			{s = "WeaponARC9_M1014_EmptyMagPouch", t = 0 / 30},
			{s = "WeaponARC9_M1014_EmptyBulletIn", t = 12 / 30},
			{s = "WeaponARC9_M1014_EmptyBolt", t = 42 / 30},
			{s = "WeaponARC9_M1014_ReloadStart", t = 50 / 30},
        },
		IKTimeLine = {
            {
                t = 0,
	...
	["reload_insert"] = {
        ...
        FireASAP = false,
		EventTable = {
            {s = "WeaponARC9_M1014_BulletIn", t = 0 / 30},
        },
		IKTimeLine = {
            {
                t = 0,
    ...
    ["inspect_look"] = {
        ...
        FireASAP = true,
		EventTable = {
            {s = "WeaponARC9_M1014_Rotate", t = 0 / 30},
			{s = "WeaponARC9_M1014_BoltBack", t = 55 / 30},
			{s = "WeaponARC9_M1014_BoltForward", t = 77 / 30},
            {s = "Generic_ClothEquip", t = 93 / 30},
        },
		IKTimeLine = {
            {
                t = 0,
	...
	["inspect"] = {
        ...
        FireASAP = true,
		EventTable = {
            {s = "WeaponARC9_M1014_MagCheckIn", t = 0 / 30},
			{s = "WeaponARC9_M1014_MagCheckOut", t = 25 / 30},
        },
		IKTimeLine = {
            {
                t = 0,
